						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/forward/forwardUserAdd'">
							...
							<!--工具栏/-->
						<form action="${pageContext.request.contextPath}/user/delSelect" method="post" id="form">
							<!--数据列表-->
							<table id="dataList"
									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="javascript:del(${user.id});" class="btn bg-olive btn-xs">删除用户</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="curr">
									<li><a href="${pageContext.request.contextPath}/user/findAll?page=${curr}&size=${pageInfo.pageSize}">${curr}</a></li>
								</c:forEach>
