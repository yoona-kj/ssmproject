...
<link rel="stylesheet"
	...
	<script>
		...
		function delById(id){
			if (confirm("你确定要删除选中条目吗？")) {
				location.href="${pageContext.request.contextPath}/product/delById?id="+id;
			}
		}
	</script>
</head>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li><a href="${pageContext.request.contextPath}/forward/forwardMain"><i class="fa fa-dashboard"></i> 首页</a></li>
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<!--工具栏/-->
						<form action="${pageContext.request.contextPath}/product/delSelect" method="post" id="form">
 							<!--数据列表-->
							<table id="dataList"
									...
									<c:forEach items="${pageInfo.list}" var="product">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='javascript:delById(${product.id});'">删除</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="curr">
									<li><a href="${pageContext.request.contextPath}/product/findAll?page=${curr}&size=${pageInfo.pageSize}">${curr}</a></li>
								</c:forEach>
