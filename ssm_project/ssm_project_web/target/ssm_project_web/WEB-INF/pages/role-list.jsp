...
<link rel="stylesheet"
	...
	<script type="application/javascript">
		function del(id){
			if(confirm("您确定要删除吗？")){
				location.href="${pageContext.request.contextPath}/role/delRole?id="+id;
			}
		}
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/forward/forwardRoleAdd'">
							...
							<!--工具栏/-->
						<form action="${pageContext.request.contextPath}/role/delSelect" method="post" id="form">
							<!--数据列表-->
							<table id="dataList"
									...
									<c:forEach items="${pageInfo.list}" var="role" varStatus="index">
										<tr>
											...
											<td class="text-center">
												...
												<a href="javascript:del('${role.id}');" class="btn bg-olive btn-xs">删除角色</a>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="curr">
									<li><a href="${pageContext.request.contextPath}/role/findAll?page=${curr}&size=${pageInfo.pageSize}">${curr}</a></li>
								</c:forEach>
